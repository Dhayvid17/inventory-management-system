...
const StaffAssignmentTerminateForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/staff-assignment/terminate-staff`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={loading}
      >
        {loading ? "Terminating..." : "Terminate Staff From Staff"}
      </button>
    </form>
  );
};

export default StaffAssignmentTerminateForm;
